    ...
    <body>
        <div id="mainMenu" name="mainMenu" class="mainMenu">
            <?php include '../index.php';?></div>
                <div id="coSpaces" name="coSpaces" class="menuOptions">
                    <?php include '../cospaces.php'?>
                </div>
                <div id="IVRs" name="IVRs" class="menuOptions">
                <?php include '../ivrs.php'?>
                </div>
                <div id="CallLegs" name="CallLegs" class="menuOptions">
                <?php include '../calllegs.php'?>
                </div>
                <div id="WebBridges" name="WebBridges" class="menuOptions">
                <?php include '../webbridges.php'?>
                </div>
                <div id="TurnServers" name="TurnServers" class="menuOptions">
